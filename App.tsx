...
const PasswordSchema = Yup.object().shape({
  ...
  .min(4,'should be of length 4')
  .max(16,'should be of max length')
...
export default function App() {
  ...
  const[numCase,setNumCase]=useState(false)
  ...
  const createPassword =(passwordLength :number, characters: string ) =>{
    ...
    for(let i=0; i < passwordLength ; i++) {
      ...
      result += characters[randomCharacterIndex]
  }
  return result
}
const resetPassword = () => {
